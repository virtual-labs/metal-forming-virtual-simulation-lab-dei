...
# - 32-bit or 64-bit RHEL/CentOS 6.6 or later (you will be asked to
#   upgrade the OS and reboot if you're running 6.5 or earlier) or
#   any 64-bit RHEL/CentOS 7 version
...
remove_redundant_libs()
# Remove redundant patched libraries from old releases
