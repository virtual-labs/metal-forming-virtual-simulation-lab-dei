...
<div class="box">
<h2>Swaging</h2><br>
Swaging is a process that is used to reduce or increase the diameter of tubes. A swagged piece created by placing the tube inside a die that applies compressive force by hammering radially.<br/>The term swage can apply to the process of swaging (verb), or to a die or tool used for swaging (noun).<br/><br/><span class="blue">Manufacturing Processes:</span> As a general manufacturing process swaging may be broken up into two categories. The first category of swaging involves the workpiece being forced through a confining die to reduce its diameter, similar to the process of drawing wire. This may also be referred to as "tube swaging." The second category involves two or more dies used to hammer a round workpiece into a smaller diameter. This process is usually called "rotary swaging" or "radial forging".
...
<br/>Swaging can be further expanded by placing a mandrel inside the tube and applying radial compressive forces on the outer diameter. Thus, through the swage process, the inner tube diameter can be a different shape, for example a hexagon, and the outer is still circular.
<br/><br/><center><img src="images/Swaging/TubeSwaging.png" alt="Rotary Image Ajay Kant Upadhyay" Height="300" width="450"><br/>Tube Swaging</center><br/>
<span class="blue">Rotary swaging:</span> Rotary swaging process is usually a cold working process, used to reduce the diameter, produce a taper, or add point to a round workpiece. It can also impart internal shapes in hollow workpieces through the use of a mandrel (the shape must have a constant cross-section). Swaging a bearing into a housing means flaring its groove's lips onto the chamber of the housing.
...
<br/><br/><center><img src="images/Swaging/RotarySwaging.png" alt="RotarySwaging Ajaykant Upadhyay" /><br/>Rotary Swaging</center><br/>
