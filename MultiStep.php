...
<div class="box">
<h2>Multi Step Forging</h2><br>
Traditionally, forging was performed by a smith using hammer and anvil, and though the use of water power in the production and working of iron dates to the 12th century, the hammer and anvil are not obsolete. The smithy or forge has evolved over centuries to become a facility with engineered processes, production equipment, tooling, raw materials and products to meet the demands of modern industry.<br/>In modern times, industrial forging is done either with presses or with hammers powered by compressed air, electricity, hydraulics or steam.<br/>Forged items have long been prized for their superior strength and durability. Forging a metal improves the following:<br/>
1)	The metal is compacted and any voids or defects are reduced.
<br/>2)	The grain flow is retained or modified to follow the new shape.
<br/>3)	Less waste since material is removed to produce a given shape.
<br/>4)	Materials which are hard to machine can be easily hot forged to shape.
<br/><br/><span class="blue">Cold working</span> is metal forming performed at room temperature.
<br/><br/><span class="blue">Hot working</span> involves deformation of preheated material at temperatures above there crystallization temperature.
<br/><br/><span class="blue">Need Of Multi Step Forging:</span> In some forging Operations the shapes to be formed are such which needs to be progressively deformed. A group of dies are to be used in a proper sequence. In every pass the die is changed. The value of force also needs to be altered according to the operation.
<br/><br/><span class="blue">Steps Of Multi Step Forging:</span><br/>
1. All Dies of different shapes must be ready in proper sequence.
<br/>2. The billet at proper temperature is pressed by first die.
<br/>3. The billet of the previous pass is taken to the next die for second pressing.
<br/>4 The final product is obtained after the last pass.
<br/><br/><span class="blue">Applications of Multi step forging:</span> Heading Operation, Valve forming etc.
<br/><br/><span class="blue">Heading Operation:</span> Heading process may be defined as an upsetting process, normally performed at the end of a round rod or wire or blank in order to produce a larger cross-section. Some of the products made by heading process are heads of bolts, screws, rivets, nails and other fasteners. Heading processes can be carried out cold, warm or hot. Heading operation is performed on the machines known as headers. These machines are highly automated. Production rates are hundreds of pieces per minutes for the small parts. Heading operation can be combined with cold-extrusion processes to make various parts.<br>An important aspect of the heading operation is the tendency for the bar to buckle if its unsupported length-to-diameter ratio is very high. This ratio is limited to less than 3:1, but it can be higher depending on the die geometry.
<br/><br/><span class="blue">STEPS OF HEADING PROCESS:</span> Heading operation is not a single step process. this operation is carried in three steps. The complete heading process is shown in following images.<br/><br/>
<span class="blue">Step-1:</span> In this step, the billet or the wire is fed from a mechanical coil through a pre-straightening machine. The straightened wire flows directly into a machine that automatically cuts the wire at a designated length. The obtained piece is known as blank. It is passed to the next stage of the heading operation.
<br/><br/><center><img src="images/Upsetting/Heading/heading1.png"></center><br/>
<span class="blue">Step-2:</span> In this step, the billet is initially deformed by the punch of the header machine. The deformation is usually very less so that material can be formed during next stages. This stage is also known as pre-forming operation.
<br/><br/><center><img src="images/Upsetting/Heading/heading2.png" width="400" height="250"></center><br/>
<span class="blue">Step-3:</span> In this stage the tapered head is obtained after heading operation. The blank head is severely deformed during the process and hence its properties improves. The temperature of the blank head rises sharply due to deformation.
<br/><br/><center><img src="images/Upsetting/Heading/heading3.png" width="400" height="250"></center><br/>
<span class="blue">Step-4:</span> In this stage final product is formed by the deformation of the taper head into round head. The round impression punch press the head and finally round head bolt is obtained. Similar steps are utilised to form hexagonal ,square and flat bolt and screws.
<br/><br/><center><img src="images/Upsetting/Heading/heading4.png" width="400" height="250"></center><br/>
<span class="blue">Final Product</span><br/><br/><center><img src="images/Upsetting/Heading/heading5.png" width="400" height="250"></center><br/>
<span class="blue">Applications of Heading Operation:</span><br/><br/><span class="blue">SCREW:</span> Screw is part of a family of threaded fasteners that include bolts and studs as well as specialized screws like carpenter's wood screws and the automotive cap screw. The threads (or grooves) can run right handed or left, tapered, straight, or parallel.
<br/><br/><span class="blue">Manufacturing process</span><br/><br/><span class="blue">Machining:</span> Machining is only used on unique designs or with screws too small to be made any other way. The machining process is exact, but too time consuming, wasteful, and expensive.
<br/><br/><span class="blue">Cold heading:</span> Wire is fed from a mechanical coil through a pre-straightening machine. The straightened wire flows directly into a machine that automatically cuts the wire at a designated length and die cuts the head of the screw blank into a pre-programmed shape. The heading machine utilizes either an open or closed die that either requires one punch or two punches to create the screw head. The closed (or solid) die creates a more accurate screw blank.
<br/><br/><span class="blue">Thread rolling:</span> Once cold headed, the screw blanks are automatically fed to the thread-cutting dies from a vibrating hopper. The hopper guides the screw blanks down a chute to the dies, while making sure they are in the correct feed position.<br>Threads can be cut into the blank by several methods. In the reciprocal method, the screw blank is rolled between two dies. In the cylindrical method, it is turned in the center of several rollers.
<br/>All three methods create higher quality screws than the machine-cut variety. This is because the thread is not literally cut into the blank during the thread-rolling process, rather it is impressed into the blank. Thus, no metal material is lost, and weakness in the metal is avoided. The threads are also more precisely positioned. The more productive of the thread-rolling techniques is by far the planetary rotary die, which creates screws at a speed of 60 to 2,000 parts per minute.
<br/><br/><center><img src="images/Upsetting/Heading/heading6.jpg" width="350" height="250">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<img src="images/Heading/heading7.jpg" width="350" height="250"></center>
<br/><br/><span class="blue">Valve Forming:</span> A valve is a device that regulates, directs or controls the flow of a fluid (gases, liquids, fluidized solids, or slurries) by opening, closing, or partially obstructing various passageways. Valves are technically pipe fittings, but are usually discussed as a separate category. In an open valve, fluid flows in a direction from higher pressure to lower pressure.
...
Valves play a vital role in industrial applications ranging from transportation of drinking water to control of ignition in a rocket engine.<br/><br/>
<center><img src="images/Upsetting/Valve.png" alt="Valve Ajay Kant Upadhyay"><br/>Valve</center><br/>
...
<br/><br/><span class="blue">Types of Valve:</span> Valve can be categorized into the following types: 
<br/><br/>• <span class="blue">Ball Valve</span>- for on/off control without pressure drop, and ideal for quick shut-off since a 90º turn offers complete shut-off angle, compared to multiple turns required on most manual valves.
<br/><br/>• <span class="blue">Butterfly valve</span>- for flow regulation in large pipe diameters.
<br/><br/>• <span class="blue">Ceramic Disc valve</span>- used mainly in high duty cycle applications or on abrasive fluids. Ceramic disc can also provide Class IV seat leakage.
<br/><br/>• <span class="blue">Check valve</span>- or non-return valve, allows the fluid to pass in one direction only.
<br/><br/>• <span class="blue">Choke valve</span>- a valve that raises or lowers a solid cylinder which is placed around or inside another cylinder which has holes or slots. Used for high pressure drops found in oil and gas wellheads.
<br/><br/>• <span class="blue">Diaphragm valve</span>- which controls flow by a movement of a diaphragm. Upstream pressure, downstream pressure, or an external source (e.g., pneumatic, hydraulic, etc.) can be used to change the position of the diaphragm.
<br/><br/>• <span class="blue">Gate valve</span>- mainly for on/off control, with low pressure drop.
<br/><br/>• <span class="blue">Globe valve</span>- good for regulating flow.
<br/><br/>• <span class="blue">Knife valve</span>- similar to a gate valve, but usually more compact. Often used for slurries or powders on/off control.
<br/><br/>• <span class="blue">Needle valve</span>- for accurate flow control.
<br/><br/>• <span class="blue">Pinch valve</span>- for slurry flow regulation.
<br/><br/>• <span class="blue">Piston valve</span>- for regulating fluids that carry solids in suspension.
<br/><br/>• <span class="blue">Plug valve</span>- slim valve for on/off control but with some pressure drop.
<br/><br/>• <span class="blue">Spool valve</span>- for hydraulic control
<br/><br/>• <span class="blue">Thermal expansion valve</span>- used in refrigeration and air conditioning systems.
<br/><br/>There is a vast abundance of valve types available for implementation into systems. The valves most commonly used in processes are ball valves, butterfly valves, globe valves, and plug valves. A summary of these four valve types and their relevant applications is in the table below.<br/><br/>
