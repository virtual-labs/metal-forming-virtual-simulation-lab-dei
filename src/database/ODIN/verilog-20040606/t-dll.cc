...
int dll_target::end_design(const Design*)
{
      ...
      /* PAJ - appears to be the call spot for the target */
//      int rc = (target_)(&des_);
      target_ = (target_design_f)target_design;
      int rc = (target_)(&des_);
      /* PAJ - look like the shutdown of the DLL link */
#if 0
      ivl_dlclose(dll_);
#endif
      return rc;
