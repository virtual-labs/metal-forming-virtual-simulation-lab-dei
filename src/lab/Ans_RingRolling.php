...
EOQ;
	$answers = $_SESSION['answer'];
	 $Curr_answers = array('Seamless rings','No','Increase diameter','Yellow color','Rotate and Translate',
	 'king roll','Mandrel','To make the width of the ring constant','2','Strain hardening');
?>
</ul></div>
