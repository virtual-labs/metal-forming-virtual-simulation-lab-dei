...
(i)	The melting points of metals range from about -39° C for mercury to 3410° C for tungsten. The resistance of a tungsten filament bulb increases ten times between room temperature and its operating temperature.<br/>
...
(iii) <b>Specific gravity</b> is the ratio of the mass of a given volume of the metal to the mass of the same volume of water at a specified temperature, usually 4°C.<br/><br/>
...
<b>Stress</b> is defined as force per unit area. It is expressed in Newtons per square metre (N/m¬2), though it is more conveniently measured in terms of Newtons per square millimetre (N/mm2).<br/>
