...
<td><input type="text" id="college" name="college" value="Dayalbagh Educational Institute" size="30" readonly /></td></tr>
...
if( $_SESSION['code'] == $_POST['securitycode'] ) {
	$dquery=mysql_query("select Email from mem103_2016");
	...
	if($f===1)
	{
	$query="insert into mem103_2016(Fname,Lname,Email,Password,Branch,College,City,State,Date) 
