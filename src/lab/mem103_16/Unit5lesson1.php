...
d. ‘Repeatable’ regular geometries with close tolerance (<0.025µm) and smooth surface finish (0.4µm) can be obtained.<br>
...
The <b>cross slide</b> is mounted on the dovetail ways on the top of the saddle and moves radially back and forth (X axis) at 90° to the axis of the lathe by the cross slide lead screw. Thus controlling the radial position of the cutting tool.<br><br>
