...
<dd><p>
Thermocouples are used for measuring temperatures usually from 200 to 1300<sup>o</sup>C. Then there are optical pyrometers which are used for measuring temperatures in higher range, 700 to 2000<sup>o</sup>C Radiation pyrometers are also available for measuring still higher temperatures.<br/>
...
Where<br/>
&sigma;<sub>f</sub> is the flow stress of the material, &mu; is the coefficient of friction, and d and h are the diameter and height of the work piece, respectively.<br/><br/>
...
2. Length of billet exceeding three times billet diameter may be upset successfully provided the diameter of cavity does not exceed 1 and half times the billet diameter.<br/>
3. In an upset requiring stock length exceeding three times billet diameter and where diameter of cavity is not exceeding 1 and half the billet diameter the length of unsupported metal beyond the face of the die must not exceed the diameter of the bar.<br/><br/>
