...
In Stage 2, the carbon monoxide burns and forms carbon dioxide, while the hydrogen which is formed in Stage 1, combines with oxygen to form water. The combustion is therefore complete and carbon dioxide and water (turned to steam) are the chief products of combustion. This produces a flame temperature of approximately 3200<sup>o</sup>C.
</p></dd><br/>
<dt><b><a name="types">2.3 &nbsp;&nbsp;&nbsp;Oxy-Acetylene Flame types</a></b></dt>
<dd><p>
The oxy-acetylene flame has three sections: the inner cone, the middle acetylene feather, and the outer flame envelope. The ratio of the length between the inner cone and the middle acetylene feather should be controlled by adjusting the gases. The temperature of the oxyacetylene flame is not uniform throughout its length of the flame. The temperature is highest just beyond the end of the inner cone and decreases gradually toward the end of the flame. It is so high up to 3316<sup>o</sup>C.<br/><br/>
...
The neutral flame is obtained when equal proportions of acetylene and oxygen are used and combustion is complete by consuming all the carbon supplied by the acetylene and the maximum heat given out. In neutral flame, the flame contracts and the white rounded shape cone become clearly visible. This type of flame is extensively used by the welder. In neutral flame, the temperature at the inner cone tip is approximately 3232<sup>o</sup>C, while at the end of the outer envelope the temperature drops to approximately 1260<sup>o</sup>C. When steel is welded with this flame, the puddle of molten metal is quiet and clear, and the metal flows without boiling, foaming, or sparking.<br/><br/>
...
Acetylene cylinder should be used in the up right position so acetone may not be drawn out of the tank. The valve has a screw tap fitted and is screwed left hand. The cylinder is painted maroon. Open the cylinder valve 1 to 1 &frac12; turns, leaving the valve wrench on the valve in the event it has to be shut off quickly. Acetylene should never be used at a pressure that exceeds 103.4 kPa. In order to decrease the size of the open spaces in the cylinder, acetylene cylinders are filled with porous materials such as balsa wood.<br/><br/>
